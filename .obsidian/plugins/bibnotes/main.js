    ...
    "node_modules/color-classifier/color-classifier.js"(exports, module2) {
        (function (global, factory) {
            ...
            function minBy(array, key) {
                var sortedArray = [].concat(
                    babelHelpers.toConsumableArray(array),
                );
            ...
            function isRgb(obj) {
                return (
                    hasProp(obj, "r") && hasProp(obj, "g") && hasProp(obj, "b")
                );
            }
            var Color = (function () {
                ...
                babelHelpers.createClass(ColorDiff2, null, [
                    ...
                    },
                    {
                        ...
                        value: function hsv(color1, color2) {
                            ...
                            return sqrt(
                                pow2(h) + pow2(a.s - b.s) + pow2(a.v - b.v),
                            );
                        },
                    },
                    {
            ...
            function equal(a, b) {
                ...
                return (
                    (typeof a === "undefined"
                        ? "undefined"
                        : babelHelpers.typeof(a)) ===
                    (typeof b === "undefined"
                        ? "undefined"
                        : babelHelpers.typeof(b))
                );
            }
                ...
                babelHelpers.createClass(ColorClassifier3, [
                    ...
                    },
                    {
                        ...
                        value: function setAlgorithmType(algorithmType) {
                            if (
                                !AlgorithmTypes2.hasOwnProperty(algorithmType)
                            ) {
                                ColorClassifier3.throwError(
                                    algorithmType +
                                        " is an undefined algorithm type.",
                                );
                            }
                    ...
                    },
                    {
                        ...
                        value: function classifyFromArray(colors) {
                            ...
                            array.forEach(function (obj) {
                                ...
                                var color = obj.color;
                                var _results$filter = results.filter(
                                    function (o) {
                                        return equal(
                                            o.palette,
                                            palette[format2],
                                ...
                                var _results$filter2 =
                                    babelHelpers.slicedToArray(
                                        _results$filter,
                                        1,
                                    );
...
var Debugout = (function () {
    function t(t2) {
        ...
        if (this.useLocalStorage && window && window.localStorage) {
            ...
            if (r) {
                ((this.output = r.log),
                    (this.startTime = new Date(r.startTime)));
    ...
    return (
        (t.prototype.startLog = function () {
            ((this.startTime = new Date()),
                this.logMetadata(
                    "Session started: " + this.formatDate(this.startTime),
                ));
        }),
        ...
        (t.prototype.getLog = function () {
            ...
            if (
                ...
                var e = this.load();
                e &&
                    ((this.startTime = new Date(e.startTime)),
                    (this.output = e.log));
            }
...
function createLocalFileLink(reference2) {
    ...
    for (
        ...
        const attachmentKey =
            selectedfileUri.split("/")[selectedfileUri.split("/").length - 1];
        selectedfile =
            "[" +
    ...
    onOpen() {
        return __async(this, null, function* () {
            ...
            for (let index = 0; index < data.items.length; index++) {
                ...
                bibtexArrayItem.authorKey = createAuthorKey(
            ...
            const selectLibrary = {
                inlineReference:
                    "Entire Library: " + this.plugin.settings.bibPath,
...
var updateLibrary = class extends import_obsidian2.Modal {
    ...
    onOpen() {
        ...
        for (let index = 0; index < data.items.length; index++) {
            ...
            for (
                let index2 = 0;
                index2 < selectedEntry.notes.length;
                index2++
            ) {
                noteDateModifiedArray.push(
                    selectedEntry.notes[index2].dateModified,
                );
        ...
        new import_obsidian2.Notice(
            "Updated " + bibtexArray.length + " entries",
        );
...
var SettingTab = class extends import_obsidian5.PluginSettingTab {
    ...
    display() {
        ...
        containerEl.createEl("h1", {
            text: "BibNotes Formatter (for Zotero) ",
        });
...
var MyPlugin = class extends import_obsidian6.Plugin {
    ...
    createFormatting() {
        ...
        if (isHighlightColoured == true) {
            highlightColouredBefore =
                '<mark style="background: SELECTED_COLOUR>';
    ...
    parseMetadata(selectedEntry, templateOriginal) {
        ...
        selectedEntry.zoteroReaderLink =
            createZoteroReaderPathLink(selectedEntry);
                    ...
                    if (lineElements.annotationType !== "typeImage") {
                        for (
                            ...
                            if (tempAnnotationType != "noKey") {
                                lineElements.annotationType =
                                    tempAnnotationType;
                                lineElements.inlineTagsArray.splice(
                                    indexTag,
                                    1,
                                );
                                break;
        ...
        for (let i = 0; i < noteElements.length; i++) {
            ...
            if (typeof lineElements.colourTemplate == "undefined") {
                lineElements.colourTemplate =
                    this.settings.highlightExportTemplate;
            }
            ...
            if (lineElements.annotationType === "typeImage") {
                ...
                if (this.settings.imagesImport) {
                    ...
                    if (this.settings.zoteroStoragePathManual.length > 0) {
                        pathImageOld = import_path2.default.format({
                            dir:
                                this.settings.zoteroStoragePathManual +
        ...
        if (selectedEntry.notes.length > 0) {
            for (
                ...
                if (
                    ...
                    userNoteElements =
                        userNoteElements.concat(noteElementsSingle);
                }
        ...
        for (
            ...
            if (Math.max(...positionArray) === -1) {
                ...
                newNoteInsertPosition.push(
                    positionNewLine.filter(
                        (pos) => pos > positionOldNoteMax,
                    )[0],
                );
            }
        }
